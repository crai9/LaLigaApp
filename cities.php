<?php
	...
	$citiesarray = array(
			array("city_id" => "1", "city_name" => "Barcelona", "region_id" => "1", "lat" => "41.3833", "long" => "2.1833",
				"images" => array(
			...
			array("city_id" => "2", "city_name" => "Madrid", "region_id" => "2", "lat" => "40.4000", "long" => "-3.7167",
				"images" => array(
			...
			array("city_id" => "3", "city_name" => "Bilbao", "region_id" => "3", "lat" => "43.2569", "long" => "-2.9236",
				"images" => array(
			...
			array("city_id" => "4", "city_name" => "Sevilla", "region_id" => "4", "lat" => "37.3772", "long" => "-5.9869",
				"images" => array(
			...
			array("city_id" => "5", "city_name" => "Valencia", "region_id" => "5", "lat" => "39.4667", "long" => "-0.3833",
				"images" => array(
			...
			array("city_id" => "6", "city_name" => "Vigo", "region_id" => "6", "lat" => "42.2314", "long" => "-8.7124",
				"images" => array(
			...
			array("city_id" => "7", "city_name" => "Eibar", "region_id" => "3", "lat" => "43.1833", "long" => "-2.4667",
				"images" => array(
			...
			array("city_id" => "9", "city_name" => "Granada", "region_id" => "4", "lat" => "37.1781", "long" => "-3.6008",
				"images" => array(
			...
			array("city_id" => "10", "city_name" => "Las Palmas de Gran Canaria", "region_id" => "7", "lat" => "28.1500", "long" => "-15.4167",
				"images" => array(
			...
			array("city_id" => "11", "city_name" => "Malaga", "region_id" => "4", "lat" => "36.7194", "long" => "-4.4200",
				"images" => array(
			...
			array("city_id" => "12", "city_name" => "San Sebastian", "region_id" => "3", "lat" => "43.3214", "long" => "-1.9856",
				"images" => array(
			...
			array("city_id" => "13", "city_name" => "Gijon", "region_id" => "8", "lat" => "43.5333", "long" => "-5.7000",
				"images" => array(
			...
			array("city_id" => "14", "city_name" => "Villarreal", "region_id" => "5", "lat" => "39.9378", "long" => "-0.1014",
				"images" => array(
			...
			array("city_id" => "15", "city_name" => "Getafe", "region_id" => "2", "lat" => "40.3047", "long" => "-3.7311",
				"images" => array(

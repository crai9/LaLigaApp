...
header('Content-Type: application/json');
	$teamsarray = array(
			array("team_id" => "1", "team_name" => "Futbol Club Barcelona", "stadium" => "Camp Nou", "badge" => "fcbarcelona_badge.png", "strips" => "fcbarcelona_strips.png", "city_id" => "1",
				"images" => array(
			...
			array("team_id" => "2", "team_name" => "Reial Club Deportiu Espanyol de Barcelona SAD", "stadium" => "RCDE", "badge" => "espanyol_badge.png", "strips" => "espanyol_strips.png", "city_id" => "1",
				"images" => array(
			...
			array("team_id" => "3", "team_name" => "Real Madrid Club de Futbol", "stadium" => "Santiago Bernabeu", "badge" => "realmadrid_badge.png", "strips" => "realmadrid_strips.png", "city_id" => "2",
				"images" => array(
			...
			array("team_id" => "4", "team_name" => "Club Atletico de Madrid SAD", "stadium" => "Vicente Calderon", "badge" => "atleticomadrid_badge.png", "strips" => "atleticomadrid_strips.png", "city_id" => "2",
				"images" => array(
			...
			array("team_id" => "5", "team_name" => "Rayo Vallecano de Madrid SAD", "stadium" => "Vallecas", "badge" => "rayovallecano_badge.png", "strips" => "rayovallecano_strips.png", "city_id" => "2",
				"images" => array(
			...
			array("team_id" => "6", "team_name" => "Athletic Club", "stadium" => "San Mames", "badge" => "athleticbilbao_badge.png", "strips" => "athleticbilbao_strips.png", "city_id" => "3",
				"images" => array(
			...
			array("team_id" => "7", "team_name" => "Real Betis Balompie SAD", "stadium" => "Benito Villamarin", "badge" => "realbetis_badge.png", "strips" => "realbetis_strips.png", "city_id" => "4",
				"images" => array(
			...
			array("team_id" => "8", "team_name" => "Sevilla Futbol Club SAD", "stadium" => "Ramon Sanchez-Pizjuan", "badge" => "sevilla_badge.png", "strips" => "sevilla_strips.png", "city_id" => "4",
				"images" => array(
			...
			array("team_id" => "9", "team_name" => "Valencia Club de Futbol SAD", "stadium" => "Mestalla", "badge" => "valencia_badge.png", "strips" => "valencia_strips.png", "city_id" => "5",
				"images" => array(
			...
			array("team_id" => "10", "team_name" => "Levante Union Deportiva SAD", "stadium" => "Ciutat de Valencia", "badge" => "levante_badge.png", "strips" => "levante_strips.png", "city_id" => "5",
				"images" => array(
			...
			array("team_id" => "11", "team_name" => "Real Club Celta de Vigo SAD", "stadium" => "Balaidos", "badge" => "celtavigo_badge.png", "strips" => "celtavigo_strips.png", "city_id" => "6",
				"images" => array(
			...
			array("team_id" => "12", "team_name" => "Sociedad Deportiva Eibar SAD", "stadium" => "Ipura", "badge" => "eibar_badge.png", "strips" => "eibar_strips.png", "city_id" => "7",
				"images" => array(
			...
			array("team_id" => "13", "team_name" => "Real Club Deportivo de La Coruna, SAD", "stadium" => "Riazor", "badge" => "deportivolacoruna_badge.png", "strips" => "deportivolacoruna_strips.png", "city_id" => "8",
				"images" => array(
			...
			array("team_id" => "14", "team_name" => "Granada Club de Futbol SAD", "stadium" => "Los Carmenes", "badge" => "granada_badge.png", "strips" => "granada_strips.png", "city_id" => "9",
				"images" => array(
			...
			array("team_id" => "15", "team_name" => "Union Deportiva Las Palmas SAD", "stadium" => "Gran Canaria", "badge" => "laspalmas_badge.png", "strips" => "laspalmas_strips.png", "city_id" => "10",
				"images" => array(
			...
			array("team_id" => "16", "team_name" => "Malaga Club de Futbol SAD", "stadium" => "La Rosaleda", "badge" => "malaga_badge.png",  "strips" => "malaga_strips.png", "city_id" => "11",
				"images" => array(
			...
			array("team_id" => "17", "team_name" => "Real Sociedad de Futbol SAD", "stadium" => "Anoeta", "badge" => "realsociedad_badge.png", "strips" => "realsociedad_strips.png", "city_id" => "12",
				"images" => array(
			...
			array("team_id" => "18", "team_name" => "Real Sporting de Gijon SAD", "stadium" => "El Molinon", "badge" => "sportinggijon_badge.png", "strips" => "sportinggijon_strips.png", "city_id" => "13",
				"images" => array(
			...
			array("team_id" => "19", "team_name" => "Villarreal Club de Futbol SAD", "stadium" => "El Madrigal", "badge" => "villarreal_badge.png", "strips" => "villarreal_strips.png", "city_id" => "14",
				"images" => array(
			...
			array("team_id" => "20", "team_name" => "Getafe Club de Futbol SAD", "stadium" => "Coliseum Alfonso Perez", "badge" => "getafe_badge.png", "strips" => "getafe_strips.png", "city_id" => "15",
				"images" => array(
